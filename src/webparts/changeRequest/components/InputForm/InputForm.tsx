...
//         handleChange("Employee_x0020_Signature", base64String);
//       };
...
//         !formData.System || !formData.User_x0020_Requirement) {
...
//                   className={styles.select}
//                 >
//                   <option value="">Select your system type...</option>
...
//                   <img src={signatureImage} alt="Signature" className={styles.signatureImg} />
//                   <button 
//                     type="button"
...
//                 </div>
//               ) : (
//                 <div className={styles.signatureUpload}>
...
//                     />
//                     <span className={styles.signatureButton}>Upload Signature</span>
//                   </label>
//                   <p className={styles.signatureHint}>Click to upload your signature image</p>
//                 </div>
//               )}
//             </div>
//           </div>
