...
import ITEquipmentTaskService from "../services/ITEquipmentTaskService";
...
const TaskDashboard = () => {
  const [ITEquipmentsTask, setITEquipmentsTask] = React.useState<IITEquipmentTask[]>([]);
  ...
  const loadData = async (): Promise<void> => {
    try {
      ...
      const data = await ITEquipmentTaskService.getITEquipmentTaskData();
      setITEquipmentsTask(data);
    } catch (error) {
  ...
  const filteredITEquipments = ITEquipmentsTask.filter((item) => {
  ...
  return (
    <div className={styles.dashboard}>
      ...
      <div className={styles.header}>
        <div className={styles.title}>IT EQUIPMENT TASK DASHBOARD</div>
      </div>
